...
config :knowbot, KnowbotWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "2Hb1rE0Ocm19SuSe8ZF4YbEDu+TPxFM24DhZ0SJJ+I++fPOZyhLZRcN5lhEf8Mxr",
  watchers: [
...
config :knowbot, KnowbotWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/knowbot_web/(live|views)/.*(ex)$",
      ~r"lib/knowbot_web/templates/.*(eex)$"
    ]
  ]
