defmodule Knowbot.Repo.Migrations.QuestionsAnswers do
  ...
  def change do
  # Create a new table called 'questions_answers'
  ...
  # Create a unique index on the 'questions_answers' table with the 'question_id' and 'answer_id' columns
  create(unique_index(:questions_answers, [:question_id, :answer_id]))
  end
end
